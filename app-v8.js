...
function resetWineForm(){
  $('wineForm').reset(); $('wineId').value=''; $('barcode').value=''; $('productId').value=''; $('labelImage').value=''; $('scanStatus').textContent='Velg strekkode eller etikett.'; $('scanPreview').hidden=true; $('scanPreview').src=''; $('candidateList').innerHTML=''; $('labelCorrection').hidden=true; $('labelSearchText').value=''; $('quantity').value=1;
}
